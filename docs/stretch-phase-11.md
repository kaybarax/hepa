...
| Per-lane live terminal/log streams for parallel Hermes-led runs | Adapter stdout/stderr JSONL stream artifact tests passed; terminal/dashboard tail surface still required |
