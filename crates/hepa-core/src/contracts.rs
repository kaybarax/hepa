...
impl HepaValidate for HepaHermesPrIntent {
    fn validate(&self) -> HepaContractResult {
        ...
        if !self.body.contains("## Changes") {
            return Err(HepaContractError::new(
                "body",
                "Hermes PR body must include a human-friendly Changes section",
            ));
        }
        ...
        if !self.body.contains("## Review") {
            return Err(HepaContractError::new(
                "body",
                "Hermes PR body must include a Review section",
            ));
        }
        if !self.body.contains("## Risk") {
            return Err(HepaContractError::new(
                "body",
                "Hermes PR body must include a Risk section",
            ));
        }
        if !self.body.contains("## Run Context") {
            return Err(HepaContractError::new(
                "body",
                "Hermes PR body must include a Run Context section",
            ));
        }
